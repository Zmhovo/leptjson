...
typedef enum { LEPT_NULL, LEPT_FALSE, LEPT_TRUE, LEPT_NUMBER, LEPT_STRING, LEPT_ARRAY, LEPT_OBJECT } lept_type;     /*枚举类型*/
...
lept_type lept_get_type(const lept_value* v);     /*返回结果类型*/
